    ...
    <header className="bg-gradient-to-r from-blue-900 via-purple-900 to-blue-900 border-b-2 border-cyan-400 py-4 px-6 shadow-lg">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="portal-effect w-8 h-8 overflow-hidden rounded-full border-2 border-green-400">
            <Image
              src="/rick-avatar.jpg"
              alt="Rick avatar"
              width={32}
          ...
          <div>
            <h1 className="neon-text text-2xl">{APP_NAME}</h1>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="hidden lg:block px-4 py-2 rounded-lg border-2 border-red-400 text-red-300 bg-red-400/10 hover:bg-red-400/20 hover:border-red-300 transition-all duration-200 font-bold text-sm disabled:cursor-not-allowed disabled:opacity-50"
            title="Clear chat"
          >
            Clear Chat
          </button>
          <button
            ...
            className="px-4 py-2 rounded-lg border-2 border-purple-400 text-purple-400 bg-purple-400/10 hover:bg-purple-400/20 hover:border-purple-300 transition-all duration-200 font-bold text-sm"
            title="Settings"
          >
            ⚙ Settings
          </button>
